...
۲. **نوار اصناف** — متحرک
۳. **مشکل** — «این‌ها برایتان آشناست؟»
۴. **راه‌حل** — قبل / بعد، بلافاصله بعد از مشکل
۵. **چطور کار می‌کند** — سه قدم
۶. **دستیارها** — شش دستیار
۷. **ربات یا دستیار هوشمند؟** — مقایسه‌ی سناریو به سناریو
۸. **امنیت** — «پیج شما، دست خودتان می‌ماند»
۹. **نظرات مشتریان** — ⚠️ کامنت‌شده، پایین را بخوانید
۱۰. **قیمت** — سه پلن، مطابق پست اینستاگرام
۱۱. **چرا شش‌ماهه؟** — پنل سبز، چسبیده به پلن
۱۲. **سوالات متداول**
۱۳. **اقدام نهایی + تماس + فوتر**

منطق: مشکل ← راه‌حل ← اجرا ← تمایز ← اعتماد ← قیمت ← رفع اعتراض ← اقدام.

...
۲. **نوار کسب‌وکارها** — متحرک، نشان می‌دهد برای چه صنفی ساخته شده
۳. **مشکل** — سه دردی که مخاطب با خودش می‌گوید «این منم»
۴. **چطور کار می‌کنه** — سه قدم
۵. **ایجنت‌ها** — شش ایجنت
۶. **ربات کلیدواژه‌ای یا ایجنت؟** — جدول مقایسه، برای توجیه اختلاف قیمت با رقبا
۷. **نتیجه** — قبل / بعد
۸. **امنیت** — رمز نمی‌گیریم، کنترل با خودت، داده مال خودت
۹. **نظرات مشتری‌ها** — ⚠️ عمداً کامنت‌شده، پایین را بخوان
۱۰. **قیمت** — سه پلن، مطابق پست‌های اینستاگرام
۱۱. **چرا شش‌ماهه؟** — پنج دلیل
۱۲. **سوالات متداول** — شامل «چرا از ربات معمولی گرون‌تره؟»
۱۳. **ایجنت‌یار چیه؟** — تعریف: همراه هوشمند کسب‌وکار تو
۱۴. **اقدام نهایی + تماس + فوتر**

منطق: مشکل ← راه‌حل ← تمایز ← اثبات ← رفع اعتراض ← قیمت ← اقدام.
